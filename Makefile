...
TEST = $(TEST_DIR)/expand.c $(TEST_DIR)/wildcard.c $(TEST_DIR)/arr_utils.c $(TEST_DIR)/builtins.c

EXPAND =	$(EXPAND_DIR)/expand_var.c $(EXPAND_DIR)/utils.c $(EXPAND_DIR)/utils/arr_utils_1.c \
			$(EXPAND_DIR)/utils/arr_utils_2.c
